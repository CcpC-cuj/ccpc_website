      ...
      <div className="form-container w-full max-w-md bg-white/5 p-8 rounded-lg shadow-lg z-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            ...
            id="btn1"
            disabled={submitting}
            className="w-full bg-indigo-600 text-white py-3 rounded hover:bg-indigo-700 transition-colors form-field disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
          >
            {submitting ? (
              <>
